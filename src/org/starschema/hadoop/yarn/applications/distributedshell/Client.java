...
public class Client {
 ...
 //Hazelcast zip 
  ...
  public static final String HAZELCAST_PATH = "Hazelcast";
  ...
  public Client(Configuration conf) throws Exception  {
    this(
      "org.starschema.hadoop.yarn.applications.distributedshell.ApplicationMaster",
      conf);
  }
  ...
  public boolean init(String[] args) throws ParseException {
    ...
    if (cliParser.hasOption("hazelcast_zip")) {
    	hazelcastZip = cliParser.getOptionValue("hazelcast_zip");
    }
  ...
  public boolean run() throws IOException, YarnException {
    ...
    if (!hazelcastZip.isEmpty()) {
        ...
        String hazelPathSuffix =
            appName + "/" + appId.toString() + "/" + HAZELCAST_PATH;
        Path hazelDst =
            new Path(fs.getHomeDirectory(), hazelPathSuffix);
...
//      }
  ...
  private void addToLocalResourcesCompressed(FileSystem fs, String fileSrcPath,
	      String fileDstPath, String appId, Map<String, LocalResource> localResources,
	      String resources) throws IOException {
	    String suffix =
	        appName + "/" + appId + "/" + fileDstPath;
